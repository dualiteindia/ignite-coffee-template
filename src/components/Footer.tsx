  ...
  return (
    <footer className="bg-black text-white pt-20 pb-8 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-24">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto">
              <p className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">Business Name</p>
              <p className="text-gray-300 text-sm tracking-wide">IGNITE PERFORMANCE LLC</p>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              {['Shipping Policy', 'Terms & Conditions', 'Privacy Policy', 'Refund Policy', 'About Us', 'Contact Us'].map((link) => (
                <li key={link}>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto text-center md:text-left">
              <p className="text-gray-500 text-xs">© Ignite 2025</p>
            </div>
          </div>
      ...
      <div className="w-full flex justify-center items-end leading-none select-none pointer-events-none mt-10">
        <h1 className="text-[22vw] font-heading font-black text-white tracking-tighter m-0 p-0 opacity-95" style={{ lineHeight: '0.75' }}>
          IGNITE
        </h1>
      </div>
    </footer>
