...
const thumbnails = [
  "https://images.unsplash.com/photo-1559525839-b184a4d698c7?auto=format&fit=crop&q=80&w=150&h=150",
  "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&q=80&w=150&h=150",
  "https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&q=80&w=150&h=150"
];

const largeReviews = [
  {
    id: 1,
    image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=600&h=800",
    name: "Victor T.",
  ...
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&q=80&w=600&h=800",
    name: "Amanda Smith",
            ...
            {smallReviews.map((review, idx) => (
              ...
              >
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Reviewed <a href="#" className="underline hover:text-orange-600">{review.product}</a>
                </p>
                <div className="mb-3">
                  <StarRating />
                </div>
