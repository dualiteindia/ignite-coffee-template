...
const FLAVORS = {
  Mocha: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/jenny_hu/ChatGPT-Image-Mar-7-2026-07_40_25-PM.webp",
  Hazelnut: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/jenny_hu/ChatGPT-Image-Mar-7-2026-08_17_58-PM.webp",
  Assorted: "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/new-templates/jenny_hu/ChatGPT-Image-Mar-7-2026-07_43_39-PM.webp"
};

type FlavorType = keyof typeof FLAVORS;

const tagsRow1 = ["10g Protein", "70mg Caffeine", "0 Sugar", "70mg L-theanine"];
const tagsRow2 = ["Calm, sustained focus", "Whey + pea blend", "Digestive enzymes"];
const tagsRow3 = ["Cafe style taste", "100% natural ingredients", "100% arabica coffee"];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="relative bg-[#e8e8e8] w-full aspect-[4/5] sm:aspect-square flex flex-col justify-between overflow-hidden">
              <div className="absolute top-6 right-6 text-right z-10">
                <span className="font-heading font-bold text-3xl leading-none block text-gray-800">7</span>
                <span className="font-heading font-bold text-xl leading-none block text-gray-800">PACK</span>
              </div>
              ...
              {(Object.keys(FLAVORS) as FlavorType[]).map((flavor) => (
                <button
                  ...
                  className={clsx(
                    ...
                    selectedFlavor === flavor ? "border-black" : "border-transparent opacity-70 hover:opacity-100"
                  )}
                >
                  <img src={FLAVORS[flavor]} alt={flavor} className="w-full h-full object-contain p-2" />
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col pt-4">
            ...
            <p className="text-gray-800 text-base mb-6 font-medium">
              Clean energy, calm focus, and daily protein—your smarter coffee ritual.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex flex-wrap gap-2">
                {tagsRow1.map(tag => (
                  <span key={tag} className="bg-[#f0f0f0] text-gray-800 text-sm font-medium px-3 py-1.5 rounded-sm">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="flex items-center space-x-3 mb-1">
              <span className="font-heading font-bold text-3xl text-gray-900">$24.99</span>
              <span className="text-gray-600 text-sm font-medium">($3.57/cup)</span>
              <span className="text-gray-400 text-sm line-through decoration-gray-400 font-medium">$29.99</span>
              <span className="bg-black text-white text-xs font-bold px-3 py-1 rounded-full">15% OFF</span>
            </div>
            <p className="text-gray-600 text-sm italic mb-8 font-medium">(Taxes Included)</p>
            ...
            <div className="border-t border-gray-900">
              <Accordion title="How to use">
                Tear open a sachet, mix with 200ml of hot or cold water/milk, froth or stir well, and enjoy your high-performance coffee.
              </Accordion>
              <Accordion title="Description">
                Ignite Functional Coffee is designed for high performers. We've combined premium Arabica coffee with high-quality protein and L-Theanine to give you sustained energy without the crash.
              </Accordion>
              <Accordion title="Full Ingredient List">
                Premium Arabica Coffee Extract, Whey Protein Isolate, Pea Protein, L-Theanine, Natural Flavors, Digestive Enzyme Blend.
              </Accordion>
              <Accordion title="Nutrition">
                Calories: 53kcal, Protein: 10g, Carbohydrates: 2g, Sugars: 0g, Fat: 0.5g.
              </Accordion>
            </div>
