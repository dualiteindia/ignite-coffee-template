  ...
  if (items.length === 0) {
    return (
      <main className="min-h-[70vh] pt-32 pb-20 px-4 flex flex-col items-center justify-center text-center bg-white animate-blur-in">
        ...
        <p className="text-gray-600 text-lg mb-8">Looks like you haven't added any fuel to your cart yet.</p>
        <Link 
          to="/shop" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                ...
                <div className="ml-6 flex-1 flex flex-col justify-between">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <span className="text-[14px] font-medium text-gray-900 block">${item.price.toFixed(2)}</span>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32">
              ...
              <div className="mb-8">
                <p className="text-[13px] text-gray-900 mb-3">Congratulations! Your order qualifies for free shipping</p>
              ...
              <div className="flex justify-between items-center border-t border-black pt-4 mb-4">
                ...
                <span className="text-[18px] font-medium text-gray-900">${subtotal.toFixed(2)}</span>
              </div>
